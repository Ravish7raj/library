...
@Component({
  selector: 'app-non-ac-facility',
  template: `
    <div class="facility-container">
      <div class="facility-header">
        <div class="header-content">
          <h1>Non-AC Facility</h1>
          <p>Spacious study area with 22 comfortable seats</p>
        </div>
      </div>
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                  <i class="fas fa-fan facility-icon me-3"></i>
                  <h2 class="card-title mb-0">Non-AC Facility Management</h2>
                </div>
...
export class NonAcFacilityComponent implements OnInit {
  ...
  ngOnInit() {
    console.log('NonAcFacilityComponent initialized');
    this.loadBookings();
  }

  loadBookings() {
    console.log('Loading bookings for NON-AC facility');
    this.http.get<Booking[]>(`${environment.apiUrl}/api/active-bookings?facility_type=NON-AC`)
      .subscribe({
        next: (bookings) => {
  ...
  openBookingModal(seat: Seat) {
    ...
    // Set facility type to NON-AC
    modalRef.componentInstance.bookingForm.patchValue({
      facilityType: 'NON-AC'
    });
